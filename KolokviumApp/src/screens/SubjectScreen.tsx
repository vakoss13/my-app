...
import {
    ...
    StyleSheet, StatusBar, Modal, TextInput, Alert, KeyboardAvoidingView, Platform
} from 'react-native'
import * as ImagePicker from 'expo-image-picker'
import { theme } from '../styles/theme'
import { useColloquiumsByFilter } from '../hooks/useColloquium'
import { addColloquium } from '../api/colloquiums'
...
export const SubjectScreen = ({ subject }: SubjectScreenProps) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            queryClient.invalidateQueries({ queryKey: ['colloquiums', subject, selectedYear, selectedSession, selectedStudyYear] })
            // Сбрасываем форму
            setNewTitle('')
            setNewDescription('')
            setNewImageUri(null)
                    ...
                    <View style={styles.modalSheet}>
                        ...
                        <View style={styles.modalButtons}>
                            <TouchableOpacity
                                ...
                                onPress={() => { setAddModalVisible(false); setNewTitle(''); setNewDescription(''); setNewImageUri(null) }}
                            >
